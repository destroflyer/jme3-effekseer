...
import static com.destroflyer.jme3.effekseer.virtual.reader.ZeroValues.getZeroValueByRangeClass;
...
public class EffekseerHelper {
    ...
    static DynamicValues parseDynamicValues_Nested(Element element, String elementNameBase, Object defaultValue, Class<? extends Range> rangeClass) {
        ...
        int type = EffekseerBasics.parseInteger(element.getChild("Type"), 0);
        switch (type) {
            case 0:
    ...
    static DynamicValues parseDynamicValues_Flat(Element parentElement, String name, String elementNameBase, Object defaultValue, Class<? extends Range> rangeClass) {
        int type = EffekseerBasics.parseInteger(parentElement, name, 0);
        switch (type) {
            case 0:
    ...
    private static SinglePvaDynamicValues parseDynamicValues_SinglePva(Element singlePva, String elementNameBase, Object defaultValue, Class<? extends Range> rangeClass) {
        Range1f base = EffekseerBasics.parseRange1f(singlePva, elementNameBase, getSingleDefaultValue(defaultValue));
        Range1f velocity = EffekseerBasics.parseRange1f(singlePva, "Velocity", 0);
        Range1f acceleration = EffekseerBasics.parseRange1f(singlePva, "Acceleration", 0);
    ...
    private static SingleEasingDynamicValues parseDynamicValues_SingleEasing(Element singleEasing, Object defaultValue, Class<? extends Range> rangeClass) {
        ...
        Range1f start = EffekseerBasics.parseRange1f(singleEasing, "Start", singleDefaultValue);
        Range1f end = EffekseerBasics.parseRange1f(singleEasing, "End", singleDefaultValue);
    ...
    private static RandomDynamicValues parseDynamicValues_Random(Element random, Object defaultValue) {
        Range1f base = EffekseerBasics.parseRange1f(random, getSingleDefaultValue(defaultValue));
    ...
    private static Range3f parseFixedRange3f(Element baseElement, Vector3f defaultValue) {
        float x = EffekseerBasics.parseFloat(baseElement, "X", defaultValue.getX());
        float y = EffekseerBasics.parseFloat(baseElement, "Y", defaultValue.getY());
        float z = EffekseerBasics.parseFloat(baseElement, "Z", defaultValue.getZ());
        return Range3f.builder()
                .x(EffekseerBasics.createFixedRange1f(x))
                .y(EffekseerBasics.createFixedRange1f(y))
                .z(EffekseerBasics.createFixedRange1f(z))
                .build();
    }
    ...
    private static Range1f parseFixedRange1f(Element baseElement, float defaultValue) {
        float value = EffekseerBasics.parseFloat(baseElement, defaultValue);
        return EffekseerBasics.createFixedRange1f(value);
    }
    ...
    private static Range parseRange(Element parentElement, String elementName, Object defaultValue, Class<? extends Range> rangeClass) {
        if (rangeClass == Range3f.class) {
            ...
            return EffekseerBasics.parseRange1f(parentElement, elementName, (float) defaultValue);
        }
        return null;
    }
    ...
    private static Range3f parseRange3f(Element parentElement, String elementName, Vector3f defaultValue) {
        ...
        Range1f x = EffekseerBasics.parseRange1f(element.getChild("X"), defaultValue.getX());
        Range1f y = EffekseerBasics.parseRange1f(element.getChild("Y"), defaultValue.getY());
        Range1f z = EffekseerBasics.parseRange1f(element.getChild("Z"), defaultValue.getZ());
    ...
    private static Range createFixedRange(Object value) {
        if (value instanceof Vector3f) {
            ...
            return EffekseerBasics.createFixedRange1f((float) value);
        }
        return null;
    }

    private static Range3f createFixedRange3f(Vector3f value) {
        Range1f x = EffekseerBasics.createFixedRange1f(value.getX());
        Range1f y = EffekseerBasics.createFixedRange1f(value.getX());
        Range1f z = EffekseerBasics.createFixedRange1f(value.getZ());
        return Range3f.builder()
                .x(x)
                .y(y)
                .z(z)
    ...
    static ColorRange parseColorRange(Element element,int defaultAlpha) {
        ...
        ColorSpace colorSpace = EffekseerBasics.parseEnum(element.getChild("ColorSpace"), ColorSpace.class, ColorSpace.RGB);
    ...
    private static ColorRange createFixedColorRange(float value, int defaultAlpha) {
        Range1f redGreenBlueRange1f = EffekseerBasics.createFixedRange1f(value);
        Range1f alphaRange1 = EffekseerBasics.createFixedRange1f(EffekseerBasics.convertColorValue(defaultAlpha));
        return ColorRange.builder()
    ...
    private static Range1f parseColorComponentRange(Element element, int defaultValue) {
        Range1f integerRange = EffekseerBasics.parseRange1f(element, defaultValue);
        float min = EffekseerBasics.convertColorValue((int) integerRange.getMin());
        float max = EffekseerBasics.convertColorValue((int) integerRange.getMax());
        float center = EffekseerBasics.convertColorValue((int) integerRange.getCenter());
