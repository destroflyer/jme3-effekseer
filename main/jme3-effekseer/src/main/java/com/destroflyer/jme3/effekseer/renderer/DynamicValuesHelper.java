...
import static com.destroflyer.jme3.effekseer.reader.ZeroValues.getZeroValueByValueClass;
...
public class DynamicValuesHelper {
    ...
    static EffectiveDynamicValues generateEffectiveDynamicValues(DynamicValues dynamicValues) {
        ...
        if (dynamicValues instanceof FixedDynamicValues) {
            ...
            Object base = generateRangeValue(fixedDynamicValues.getBase());
            ...
            Object base = generateRangeValue(pvaDynamicValues.getBase());
            Object velocity = generateRangeValue(pvaDynamicValues.getVelocity());
            Object acceleration = generateRangeValue(pvaDynamicValues.getAcceleration());
            ...
            Object base = generateSingleRangeValue(singlePvaDynamicValues.getRangeClass(), singlePvaDynamicValues.getBase());
            Object velocity = generateSingleRangeValue(singlePvaDynamicValues.getRangeClass(), singlePvaDynamicValues.getVelocity());
            Object acceleration = generateSingleRangeValue(singlePvaDynamicValues.getRangeClass(), singlePvaDynamicValues.getAcceleration());
            effectiveDynamicValues = EffectivePvaDynamicValues.builder()
                    .velocity(velocity)
                    .acceleration(acceleration)
                    .build();
            ...
            Object start = generateRangeValue(easingDynamicValues.getStart());
            Object end = generateRangeValue(easingDynamicValues.getEnd());
            effectiveDynamicValues = EffectiveEasingDynamicValues.builder()
                    .start(start)
                    .end(end)
                    .build();
            localBaseValue = getZeroValueByValueClass(start.getClass());
            ...
            Object start = generateSingleRangeValue(singleEasingDynamicValues.getRangeClass(), singleEasingDynamicValues.getStart());
            Object end = generateSingleRangeValue(singleEasingDynamicValues.getRangeClass(), singleEasingDynamicValues.getEnd());
            effectiveDynamicValues = EffectiveEasingDynamicValues.builder()
                    .start(start)
                    .end(end)
                    .build();
            ...
            Object base = generateRangeValue(randomDynamicValues.getBase());
            effectiveDynamicValues = EffectiveFixedDynamicValues.builder()
                    .base(base)
                    .build();
            localBaseValue = base;
        ...
        effectiveDynamicValues.setCurrentLocalRelativeValue(getZeroValueByValueClass(localBaseValue.getClass()));
