...
import com.destroflyer.jme3.effekseer.model.RibbonDrawingValues;
import com.jme3.math.*;
import com.jme3.util.TempVars;

import java.util.ArrayList;

import static com.destroflyer.jme3.effekseer.renderer.TransformHelper.getWorldLocation;
...
public class RibbonMesh extends MergedParticlesMesh<EffectiveDrawingValues, RibbonDrawingValues> {
    ...
    private  void setToothPosition(Vector3f toothPosition, int segmentIndex, float position) {
        ...
        toothPosition.set(getWorldLocation(particles.get(segmentIndex), toothRelativePosition));
        tempVars.release();
    }
